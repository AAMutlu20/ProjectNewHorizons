...
namespace Player
{
    ...
    public class PlayerHealth : MonoBehaviour
    {
        ...
        private void OnEnemyAttack(EnemyAttackEvent attack)
        {
            ...
            // HitConfirmed attacks (e.g. laser raycast) have already validated
            // the hit geometrically — skip the proximity gate entirely.
            // Contact/melee attacks report the enemy's position and need the
            // gate to confirm they're actually adjacent to the player.
            if (!attack.HitConfirmed)
            {
